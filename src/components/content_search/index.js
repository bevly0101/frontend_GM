...
export function Content_Search(){
    ...
    const CONTENT = STATE.search_something.only_music.researched ? <Searched_music/> : (<Container className="page"><h1>Search your music and download NOW!!!</h1><img className="decoration_page_img" src="./images/search_theme.svg"/></Container>)
